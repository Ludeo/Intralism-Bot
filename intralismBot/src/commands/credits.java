...
public class credits {
	...
	public static void main(String[] args, String prefix, MessageReceivedEvent event) {
		...
		+ " all maps to see if they are broken or not, Special Thanks to Yokkako#3451 for changing the color of the Intralism Bots profile" 
		+ " picture and Special Thanks to LittleEcho#0001 for helping me setting the bot up on my Raspberry Pi");
