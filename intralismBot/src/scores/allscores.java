...
public class allscores {
	...
	public static Object[][] getAllScores(String link) throws IOException {
    	...
    	allscores[10][0] = (String)"Bryce Fox - Horns (STÃ©LOUSE Remix)";
    	...
    	allscores[37][0] = (String)"EnV â€“ Anubis";
    	...
    	allscores[45][0] = (String)"Halsey â€’ Gasoline";
    	...
    	allscores[74][0] = (String)"Monetochka â€” It is a Pain";
    	allscores[74][5] = (double) 11.1;
    	allscores[74][7] = (String)"Not Broken";
    	
    	allscores[75][0] = (String)"Monetochka â€” Mom, I don't drop siegs";
    	...
    	allscores[77][0] = (String)"Namice â€“ Perfection";
    	...
    	allscores[94][0] = (String)"Porter Robinson & Madeon â€’ Shelter [Remix by happy30]";
    	...
    	allscores[99][0] = (String)"Rameses B â€“ Infinity";
    	allscores[99][5] = (double) 11.18;
    	allscores[99][7] = (String)"Not Broken";
    	
    	allscores[100][0] = (String)"Rameses B â€“ Visionary";
    	...
    	allscores[117][0] = (String)"Tears for Fears â€’ Mad World [Cover by Adam Lambert]";
		...
		while((line=bufReader.readLine()) != null)
		{
			...
			} else if(line.contains("EnV â€“ Anubis") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Halsey â€’ Gasoline") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Monetochka â€” It is a Pain") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Monetochka â€” Mom, I don't drop siegs") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Namice â€“ Perfection") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Madeon â€’ Shelter [Remix by happy30]") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Rameses B â€“ Infinity") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Rameses B â€“ Visionary") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Tears for Fears â€’ Mad World [Cover by Adam Lambert]") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
			...
			} else if(line.contains("Ayaponzu â€’ Super Nuko World") && !line.contains("Random") && !line.contains("Hidden") && !line.contains("Endless")) {
	...
	public static String[] getUser_Rank(String link) throws IOException {
		Document doc = Jsoup.connect(link).get();
		String profileInfo = doc.toString();
		BufferedReader bufReader = new BufferedReader(new StringReader(profileInfo));
		String line=null;
